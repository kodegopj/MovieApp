...
function Slider() {
  ...
  return (
    <div>
      ...
      <div className={'slider flex overflow-x-auto w-full px-16 py-4 scrollbar-hide scroll-smooth'} ref={elementRef}>
        {movieList.map((movie)=>(
          <img  src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`}
          className='min-w-full h-[350px] object-cover 
          object-right-top mr-5 rounded-md hover:border-[4px] border-gray transition-all duration-100 ease-in '/>
        ))}
      </div>
    </div>
  )
